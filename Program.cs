...
namespace injector
{
    class Program
    {
        ...
        static void Main()
        {
            Console.Title = "Teohook injector made by ama edited by Raider#8722";

            if (!File.Exists("teohook.dll"))
            {
                Console.WriteLine("Cant find teohook.dll.");
                Console.ReadKey();
                return;
            }
        ...
        public static void inject()
        {
            ...
            var fi = new FileInfo("teohook.dll");
